...
class PetFriends:
    ...
    def get_api_key(self, email: str, passwd: str) -> json:
        """Метод отправляет запрос к API сервера и возвращает статус запроса и результат в формате
    ...
    def get_list_of_pets(self, auth_key: json, filter: str = "") -> json:
        ...
        со списком найденных питомцев, совпадающих с фильтром. Сейчас фильтр может иметь
    ...
    #Mетоды, которые еще не были реализованы
